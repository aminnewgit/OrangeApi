...
from orange_api.http.response import Response, get_error_response
...
class WebSocketClient:
  ...
  def __init__(self):
    ...
    async def on_message(msg,opcode,client):
  ...
  def exec_on_message(self,msg,opcode):
    ...
    loop.create_task(self.on_message(msg,opcode,self))
